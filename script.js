...
const mbtiDescriptions = {
  'ISTJ': '責任感が強く、現実的で着実に物事を進めるタイプ。',
  'ISFJ': '思いやりがあり、周囲をサポートすることが得意なタイプ。',
  'INFJ': '理想主義で直感的、他者の気持ちに敏感なタイプ。',
  'INTJ': '戦略的で独創的、計画的に物事を進めるタイプ。',
  'ISTP': '柔軟で現実的、問題解決が得意なタイプ。',
  'ISFP': '穏やかで感受性が豊か、自由を大切にするタイプ。',
  'INFP': '理想を追い求め、独自の価値観を持つタイプ。',
  'INTP': '論理的で分析的、新しいアイデアを考えるのが好きなタイプ。',
  'ESTP': '行動的で現実的、臨機応変に対応できるタイプ。',
  'ESFP': '社交的で明るく、周囲を楽しませるタイプ。',
  'ENFP': '創造的で情熱的、人とのつながりを大切にするタイプ。',
  'ENTP': '好奇心旺盛で柔軟、新しいことに挑戦するタイプ。',
  'ESTJ': 'リーダーシップがあり、組織的に物事を進めるタイプ。',
  'ESFJ': '協調性が高く、周囲に気配りができるタイプ。',
  'ENFJ': '人を導き、サポートすることが得意なタイプ。',
  'ENTJ': '目標志向で戦略的、リーダーシップを発揮するタイプ。',
};
